...
public class TextCheckProfileCell extends FrameLayoutFixed {
    ...
    public TextCheckProfileCell(Context context) {
        super(context);
    ...
    public TextCheckProfileCell(Context context, boolean alignLeft) {
        super(context);
        ...
        layoutParams.width = LayoutParams.MATCH_PARENT;
        layoutParams.height = LayoutParams.MATCH_PARENT;
        layoutParams.leftMargin = AndroidUtilities.dp(alignLeft ? 16 : 71);
        layoutParams.rightMargin = AndroidUtilities.dp(17);
        layoutParams.gravity = LocaleController.isRTL ? Gravity.RIGHT : Gravity.LEFT;
        textView.setLayoutParams(layoutParams);
