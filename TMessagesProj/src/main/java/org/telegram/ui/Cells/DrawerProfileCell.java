...
public class DrawerProfileCell extends FrameLayout {
    ...
    public DrawerProfileCell(Context context) {
        ...
        tv_unread.setBackgroundResource(R.drawable.ic_unread);
        tv_unread.setTextSize(12);
        tv_unread.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        tv_unread.setTextColor(Color.WHITE);
        tv_unread.setGravity(Gravity.CENTER);
        addView(tv_unread);
        layoutParams = (LayoutParams) tv_unread.getLayoutParams();
        layoutParams.width = AndroidUtilities.dp(20);
        layoutParams.height = AndroidUtilities.dp(20);
        layoutParams.gravity = Gravity.LEFT | Gravity.BOTTOM;
        layoutParams.leftMargin = AndroidUtilities.dp(65);
        layoutParams.bottomMargin = AndroidUtilities.dp(115);
        ...
        addView(arrow);
        layoutParams = (LayoutParams) arrow.getLayoutParams();
    ...
    public void setUser(TLRPC.User user) {
        ...
        int number = PreferenceUtils.getUnReadComments() + PreferenceUtils.getUnReadVotes();
