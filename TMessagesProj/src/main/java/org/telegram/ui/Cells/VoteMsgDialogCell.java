...
public class VoteMsgDialogCell extends BaseCell {
    ...
    public VoteMsgDialogCell(Context context) {
        super(context);
        init();
    ...
    public void buildLayout() {
        ...
        if (message.messageOwner.voteValue != 0) {
...
//            nameString = chat.title;
            nameString = ContactsController.formatName(currentUser.first_name, currentUser.last_name);
        } else if (user != null) {
    ...
    public void update(int mask) {
        ...
        currentUser = MessagesController.getInstance().getUser(message.messageOwner.from_id);
            if (currentUser != null) {
                ...
                currentPhoto = null;
                avatarDrawable.setInfo(message.messageOwner.from_id, null, null, false);
            }
