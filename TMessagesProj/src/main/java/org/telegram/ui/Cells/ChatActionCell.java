...
public class ChatActionCell extends BaseCell {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (currentMessageObject == null) {
            setMeasuredDimension(MeasureSpec.getSize(widthMeasureSpec), textHeight + AndroidUtilities.dp(14) + AndroidUtilities.dp(8));
            return;
        }
        ...
        if (width != previousWidth) {
            ...
            if (currentMessageObject.type == 11) {
                imageReceiver.setImageCoords((width - AndroidUtilities.dp(64)) / 2, textHeight + AndroidUtilities.dp(15) + AndroidUtilities.dp(8), AndroidUtilities.dp(64), AndroidUtilities.dp(64));
            }
        }
        setMeasuredDimension(width, textHeight + AndroidUtilities.dp(14 + (currentMessageObject.type == 11 ? 70 : 0))+ AndroidUtilities.dp(8));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        backgroundDrawable.setBounds(textX - AndroidUtilities.dp(5), AndroidUtilities.dp(5) + AndroidUtilities.dp(8), textX + textWidth + AndroidUtilities.dp(5), AndroidUtilities.dp(9) + textHeight + AndroidUtilities.dp(8));
        ...
        if (textLayout != null) {
            canvas.save();
            canvas.translate(textXLeft, textY + AndroidUtilities.dp(8));
