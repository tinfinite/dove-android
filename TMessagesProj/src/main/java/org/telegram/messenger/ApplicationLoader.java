...
import com.tinfinite.android.sdk.AppContext;
...
public class ApplicationLoader extends MultiDexApplication {
    ...
    private static final String PROPERTY_ID = "UA-60803712-4";
    ...
    public void onCreate() {
        ...
        Tracker currentTracker = getTracker(TrackerName.APP_TRACKER);
        ...
        JPushInterface.setDebugMode(T8Log.DEBUG);
