...
//                }
    ...
    public void addContact(String phone, String first_name, String last_name) {
...
//                }
    ...
    public static String formatName(String firstName, String lastName) {
        ...
        if(isContainUTF8(firstName) || isContainUTF8(lastName) ) {
            isUTF8 = true;
        }
        if (LocaleController.nameDisplayOrder == 1 && !isUTF8) {
            result = firstName;
    ...
    private static boolean isContainUTF8(String str) {
        boolean flag = false;
