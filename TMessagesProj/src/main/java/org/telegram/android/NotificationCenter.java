...
public class NotificationCenter {
    ...
    public static final int topDialogsNeedReload = totalEvents++;
    ...
    public static final int viewVoteMessage = totalEvents++;
    ...
    public static final int voteUpdateOne = totalEvents++;
    public static final int voteUpdateMany = totalEvents++;
    public static final int getJPush = totalEvents++;
    // post
    public static final int postDidupdated = totalEvents++;
    public static final int postDidLoaded = totalEvents++;
    public static final int postsEndReached = totalEvents++;
    public static final int chatFromPublicPost = totalEvents++;
    public static final int dialogUnreadPostNumDidLoaded = totalEvents++;
