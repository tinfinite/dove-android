...
/**
 * Created by PanJiafang on 14/12/1.
 */
public abstract class HeaderFooterRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     */
    public int getFooterItemViewType(int position) {
        return 0;
    }
     ...
     */
    public abstract RecyclerView.ViewHolder onCreateHeaderItemViewHolder(ViewGroup parent, int headerViewType);
     ...
     * @return the view holder.
     */
    public abstract RecyclerView.ViewHolder onCreateFooterItemViewHolder(ViewGroup parent, int footerViewType);
     ...
     * @return the view holder.
     */
    public abstract RecyclerView.ViewHolder onCreateContentItemViewHolder(ViewGroup parent, int contentViewType);
     ...
     * @param position         the position.
     */
    public abstract void onBindHeaderItemViewHolder(RecyclerView.ViewHolder headerViewHolder, int position);
     ...
     * @param position         the position.
     */
    public abstract void onBindFooterItemViewHolder(RecyclerView.ViewHolder footerViewHolder, int position);
     ...
     * @param position          the position.
     */
    public abstract void onBindContentItemViewHolder(RecyclerView.ViewHolder contentViewHolder, int position);
